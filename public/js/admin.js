...
function normalizeSite(){
  ...
  if(!site.brand)site.brand={};if(!site.event)site.event={};if(!site.access)site.access={};if(!site.recruit)site.recruit={};if(!site.socials)site.socials={};if(!site.copy)site.copy={};
}
